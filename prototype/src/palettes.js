// Palette definitions for the Skill Manager.
// Each palette is a complete color system — applied wholesale via Settings.
...
window.PALETTE_OPTIONS = [
  ['#0a84ff', '#ebebf0', '#ffffff', '#34c759'], // cool
  ['#7a4b2b', '#f1ede2', '#faf8f3', '#5b7a4a'], // warm
  ['#38527e', '#e2e5eb', '#ffffff', '#0f766e'], // slate
];

window.PALETTE_KEYS = ['cool', 'warm', 'slate'];
